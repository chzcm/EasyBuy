...
<head>
    ...
    <script type="text/javascript" src="../js_biz/register.js"  charset="utf-8"></script>
...
<div class="log_bg">
    ...
    <div class="regist">
        ...
        <div class="reg_c">
            <form action="http://10.10.1.73:8080/EasyBuy/user/add" method="post">
                <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="50">
                        ...
                        <td><input type="radio" name="sex" value="1" class="l_sex" />男
                            <input type="radio" name="sex" value="0" class="l_sex" />女</td>
                    </tr>
                    <tr height="50">
                        <td align="right"><font color="#ff4e00">*</font>&nbsp;类别 &nbsp;</td>
                        <td><input type="radio" name="type" value="1" class="l_sex" />店主
                            <input type="radio" name="type" value="0" class="l_sex" />顾客</td>
                    </tr>

                    <tr height="50">
                        <td align="right">身份证号码 &nbsp;</td>
                        <td><input type="text" name="identityCode" value="" class="l_mem" /></td>
                    </tr>
